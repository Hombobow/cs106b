...
private:
    //an array of data points to store the min heap
    DataPoint* _elements;

    //an integer to track the number of elements the heap
    int _numFilled;

    //an integer to track the max number of elements the heap can hold
    int _numAllocated;
